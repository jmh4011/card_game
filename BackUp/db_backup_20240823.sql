...
INSERT INTO `deck_cards` VALUES (1,7,1,1),(2,7,2,2),(3,7,3,3);
...
--
-- Table structure for table `game_historys_moves`
--

DROP TABLE IF EXISTS `game_historys_moves`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `game_historys_moves` (
  `move_id` int NOT NULL AUTO_INCREMENT,
  ...
  KEY `game_id` (`game_id`),
  KEY `user_id` (`user_id`),
  KEY `ix_game_historys_moves_move_id` (`move_id`),
  CONSTRAINT `game_historys_moves_ibfk_1` FOREIGN KEY (`game_id`) REFERENCES `game_historys` (`game_id`),
  CONSTRAINT `game_historys_moves_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `game_historys_moves`
--

LOCK TABLES `game_historys_moves` WRITE;
/*!40000 ALTER TABLE `game_historys_moves` DISABLE KEYS */;
/*!40000 ALTER TABLE `game_historys_moves` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user_stats` VALUES (1,1,'test',0,'2024-08-02 03:01:19'),(2,3,'1',0,'2024-08-14 03:17:04'),(3,4,'2',0,'2024-08-14 04:20:44');
...
INSERT INTO `users` VALUES (1,'admin','$2b$12$FDNXSvNPBQtcLakSzll8jeFML6AKusafQ.LzFtOdokbA8dCqAiMRK','2024-07-12 06:27:29','eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIxNWI1YjNlMC1lY2ZkLTQ2MGEtOTQzZC04MzkxZWM3OGE1MzEiLCJleHAiOjE3MjQ3MjU4MzksInVpZCI6MX0.Q7Av7KxWxS1eX2BUOqxozsuOwjQzA0S_DLfp_gutWW0','2024-08-27 02:30:39'),(3,'1','$2b$12$b/9ghFQ4RO.fuUPQkFCzI.nCHLF53KMuMho2MU92W2wMWY85XaB9e','2024-08-14 03:17:04','eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJiMWIzOWY2ZC03NDE5LTRjZjctODc1OC05ZDE3ZDZmMjlkMjAiLCJleHAiOjE3MjQyMTc3MTgsInVpZCI6M30.799sJH0bkvJ4SmwfkpPS2fs8PfIbnPXYPC0dZ5o_qJg','2024-08-21 05:21:59'),(4,'2','$2b$12$wlN.15mI/C1YZYM.MBKZYO/HHePSDxucVYwXuanrmykNzrKaNUZe.','2024-08-14 04:20:44','eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiI5NzVkYWNjMS1jZWY4LTRmNzUtOTJmNS05OWQ1MTc2ZTUwMzYiLCJleHAiOjE3MjQyMTc2MjIsInVpZCI6NH0.imTPmJG5LSxsdtH5t85v_lt7LbqGiZ8GrbNPH55N9D4','2024-08-21 05:20:22');
...
-- Dump completed on 2024-08-23 17:44:50
